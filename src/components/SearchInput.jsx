  ...
  return (
    <div className='px-8'>
        <form action="" className='flex justify-between rounded-full mx-auto border-2 max-w-96 mt-8 pl-2 overflow-hidden' onSubmit={handleOnSubmit}>
            <input type="text" onChange={(e)=>setInputQuery(e.target.value)} className='border-none dark:text-white outline-none px-2 w-full bg-transparent py-2 pl-2' placeholder='Search Movie...'/>
